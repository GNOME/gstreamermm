...
_CONVERSION(`GstObject*',`Glib::RefPtr<Object>',`Glib::wrap($3)')
_CONVERSION(`GstObject*',`Glib::RefPtr<const Object>',`Glib::wrap($3)')
#_CONVERSION(`GObject*',`Glib::RefPtr<Glib::Object>',`Glib::wrap($3)')
#_CONVERSION(`GObject*',`Glib::RefPtr<Glib::Object>',`Glib::wrap($3)')
_CONVERSION(`const Glib::RefPtr<Object>&',`GstObject*',__CONVERT_REFPTR_TO_P)
